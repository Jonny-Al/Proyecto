...
(function (global, factory) {
    ...
    var RAW_EN_LOCALE = {
        ...
        dir: 'ltr',
        buttonText: {// Aca se edita el ingles o español 
            prev: 'prev',
            next: 'next',
            prevYear: 'prev year',
            nextYear: 'next year',
        ...
        eventLimitText: 'Mas',
        noEventsMessage: 'En esta fecha no existen eventos'
    };

    function parseRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'es'; // Español e ingles es o en
